...
const Directions = () => {
    ...
    return (
        <section id="expertise" className="py-12 md:py-24 bg-white overflow-hidden">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-8 mb-10 md:mb-20">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold text-[#0a1e2b] leading-tight tracking-tight mb-4 md:mb-8">
                            Медицинская <br />
                            <span className="text-[#007f94]">экспертиза</span>
                            <span className="text-slate-400 font-light italic ml-0 md:ml-3 text-2xl md:text-3xl tracking-normal block md:inline">— по ключевым направлениям</span>
                        </h2>
                    </FadeIn>
